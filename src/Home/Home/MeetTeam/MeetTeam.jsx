    ...
    return (
        <div className="text-center mt-24 max-w-screen-xl mx-auto px-4 py-5">
            <div>
                ...
                <p className="mb-2 ">
                    Meet the Minds Behind the Magic: Get to Know the Creative Forces Shaping Our Blog!
                </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 ">
                ...
                <MeetTeamCard
                    ...
                    expertise="Fashion and Style Expert"
                />
                <MeetTeamCard
                    imgSrc="https://i.ibb.co/tqRk6nt/member3.png"
                    name="Rokib Hossain"
                    expertise="Book Reviews Expert"
                />
                <MeetTeamCard imgSrc="https://i.ibb.co/8sBVbRH/member4.png" name="Chaity" expertise="Technology Expert" />
            </div>
        </div>
    );
};
